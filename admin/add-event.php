        ...
        try {
            $stmt = $conn->prepare("
                INSERT INTO events (title, description, category_id, event_date, event_time, 
                                   location, price, total_seats, banner_image, is_featured, created_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())
            ");
                        ...
                        <form method="POST" class="event-form">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="total_seats" name="total_seats" min="1" 
                                           value="<?= htmlspecialchars($_POST['total_seats'] ?? '100') ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" id="banner_image" name="banner_image" 
                                       value="<?= htmlspecialchars($_POST['banner_image'] ?? '') ?>"
